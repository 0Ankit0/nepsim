...
final _filterProvider = NotifierProvider<_FilterNotifier, String>(_FilterNotifier.new);

class _FilterNotifier extends Notifier<String> {
  @override
  String build() => _NotificationFilter.all;
              ...
              children: [
                _FilterChip(
                  ...
                  onSelected: () => ref
                      ...
                      .setFilter(_NotificationFilter.all),
                ),
                ...
                _FilterChip(
                  ...
                  onSelected: () => ref
                      .read(_filterProvider.notifier)
                      .setFilter(_NotificationFilter.unread),
                ),
              ],
            ),
          ),
