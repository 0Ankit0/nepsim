...
# ── NEPSIM domain routers ────────────────────────────────────────────────────
from src.apps.market.api import router as market_router
from src.apps.simulator.api import router as simulator_router
...
app = FastAPI(
    lifespan=lifespan,
    title="NEPSIM — NEPSE Market Simulator & AI Learning Platform",
    description=(
        "A gamified stock trading simulator for Nepal Stock Exchange (NEPSE). "
        "Learn trading through simulation and receive AI-powered performance analysis."
    ),
    version="0.1.0",
...
# ── NEPSIM domain routers ───────────────────────────────────────────────────
app.include_router(market_router, prefix=settings.API_V1_STR, tags=["Market Data"])
